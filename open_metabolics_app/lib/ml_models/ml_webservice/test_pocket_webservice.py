...
model_file_path = 'pocket_motion_correction_model.pkl'
...
test_input = np.random.rand(num_samples, 91)

# Part 1: Prediction via API

# Define the URL of your local API endpoint
# url = "http://localhost:8080/predict_pocket_motion_correction"
url = "http://open-metabolics-mlws-env.eba-tptibabm.us-east-1.elasticbeanstalk.com/predict_pocket_motion_correction"
...
if api_predicted_output is not None:
    api_predicted_output = np.array(api_predicted_output).reshape(num_samples, 90)
